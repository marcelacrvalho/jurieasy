...
export default function CompletedDocumentsModal({
    ...
    const renderPreviewContent = () => (
        <div className="h-full flex flex-col">
                ...
                <div className="flex items-center justify-between p-6">
                    <div className="flex items-center gap-4">
                        <button
                            ...
                            className="flex items-center gap-2 text-blue-600 hover:text-blue-800 transition-colors p-2 rounded-full hover:bg-blue-50"
                        >
            ...
            <div className="flex-1 overflow-y-auto"> {/* ✅ ADICIONE overflow-y-auto AQUI */}
    ...
    const renderListContent = () => (
        <div className="flex flex-col h-full"> {/* ✅ Container flexível */}
            {/* Header - FIXO */}
            <div className="flex-shrink-0 bg-white border-b border-slate-200">
                <div className="flex items-center justify-between p-6">
                    <div>
            ...
            {/* Conteúdo - COM SCROLL */}
            <div className="flex-1 overflow-y-auto"> {/* ✅ Agora ocupa o espaço restante */}
                <div className="p-6"> {/* ✅ Movemos o padding para dentro */}
                    {isLoadingUserDocument ? (
                        <div className="flex flex-col items-center justify-center py-12">
                            <LoadingAnimation />
                            <p className="text-slate-600 mt-4">Carregando seus documentos...</p>
                        </div>
                            ...
                            {filteredDocuments.map((document) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className="flex items-center justify-between p-4 border border-slate-200 rounded-xl hover:border-blue-300 hover:shadow-md transition-all duration-300 bg-white group"
                                    >
                                        ...
                                        <button
                                            ...
                                            className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-all duration-300 flex-shrink-0 ml-4"
                                        >
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-[9999] p-4">
            <div className={`bg-white rounded-2xl shadow-2xl overflow-hidden ${showPreview
                ? 'w-full max-w-6xl h-[95vh]'
                : 'w-full max-w-4xl h-[65vh]'
