...
export default function DocumentManagerModal({
    ...
    // CONTEÚDO DO WIZARD (substitui o conteúdo do modal)
    ...
    // CONTEÚDO DA SELEÇÃO (conteúdo original)
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className={`bg-white rounded-2xl shadow-2xl overflow-hidden ${showWizard
                ? 'w-full max-w-4xl h-[90vh]'  // Tamanho maior para Wizard
                : 'w-full max-w-4xl max-h-[90vh]'  // Tamanho normal para seleção
                }`}>
