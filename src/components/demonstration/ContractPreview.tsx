...
export default function ContractDocument({
    ...
    return (
        <div className="min-h-screen inset-0 bg-[radial-gradient(circle_at_top_right,rgba(59,130,246,0.15),transparent_70%)] py-12 text-white">
            <div className="max-w-5xl mx-auto px-6">
                {/* Header */}
                <header className="flex flex-col xs:flex-row bg-blue-600 justify-between items-stretch xs:items-center gap-3 mb-10 border border-blue-800/30 rounded-2xl p-4 backdrop-blur-md shadow-lg">
                    {/* Lado esquerdo: Título alinhado à esquerda */}
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                        <button
                            onClick={onBack}
                            className="flex items-center gap-2 text-white hover:text-white transition flex-shrink-0"
                        >
                            <svg
                                className="w-5 h-5"
                                fill="none"
                        ...
                        <h1 className="text-lg font-bold text-white truncate flex-1 text-center xs:text-left">Seu Contrato</h1>
                    </div>

                    {/* Lado direito: Botões compactos */}
                    <div className="flex gap-2 w-full xs:w-auto xs:flex-shrink-0">
                        <button
                            onClick={() => setIsEditing(!isEditing)}
                            className={`px-3 xs:px-3 py-2 rounded-full font-semibold transition-all duration-200 flex-1 xs:flex-initial text-sm xs:text-base text-center min-w-0 xs:min-w-[100px] ${isEditing
                        ...
                        <button
                            ...
                            className="bg-blue-700 hover:bg-blue-500 text-white px-3 xs:px-3 py-2 rounded-full font-semibold transition-all duration-200 flex-1 xs:flex-initial text-sm xs:text-base text-center min-w-0 xs:min-w-[100px]"
                        >
                            Baixar PDF
                        </button>
                    </div>
                ...
                <div className="mt-6 text-center">
                    <div className="bg-hrey-300 border border-blue-800/40 rounded-xl p-4 inline-block">
